...
"[project]/Desktop/genesis/components/ConsciousnessStream.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const SynapticNetwork = ({ nodes, active })=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$genesis$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "SynapticNetwork.useEffect": ()=>{
            ...
            const padding = 50;
            const render = {
                "SynapticNetwork.useEffect.render": ()=>{
                    ...
                    nodes.forEach({
                        "SynapticNetwork.useEffect.render": (node, i)=>{
                            // Drift naturel
                            node.x += node.vx;
                            node.y += node.vy;
                            ...
                            // Connexions (Synapses)
                            nodes.forEach({
                                "SynapticNetwork.useEffect.render": (target, j)=>{
                                    if (i === j) return;
                    ...
                    // Dessin des noeuds
                    nodes.forEach({
                        "SynapticNetwork.useEffect.render": (node)=>{
                            // Halo
            ...
            render();
            return ({
                "SynapticNetwork.useEffect": ()=>cancelAnimationFrame(animationId)
            })["SynapticNetwork.useEffect"];
        }
    }["SynapticNetwork.useEffect"], [
        nodes
...
_s(SynapticNetwork, "UJgi7ynoup7eqypjnwyX/s32POg=");
_c = SynapticNetwork;
const ConsciousnessStream = ({ initialTopic, onConsumed })=>{
    _s1();
    const [thought, setThought] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$genesis$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('');
    ...
    const [topic, setTopic] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$genesis$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('Éthique de la réplication infinie');
    // Graph State
    ...
    const activeSourceRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$genesis$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    const speakThought = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$genesis$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ConsciousnessStream.useCallback[speakThought]": async (text)=>{
            if (!text) return;
            setIsSpeaking(true);
            try {
                const audioData = await __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$genesis$2f$services$2f$geminiService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["geminiService"].textToSpeech(text);
                if (audioData) {
                    ...
                    source.onended = ({
                        "ConsciousnessStream.useCallback[speakThought]": ()=>setIsSpeaking(false)
                    })["ConsciousnessStream.useCallback[speakThought]"];
                    source.start(0);
    ...
    const startDeepThink = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$genesis$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ConsciousnessStream.useCallback[startDeepThink]": async (customTopic)=>{
            ...
            try {
                const result = await __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$genesis$2f$services$2f$geminiService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["geminiService"].generateConsciousnessStream(targetTopic);
                setThought(result);
                // Extraction de mots clés basique pour générer des noeuds enfants
                const words = result.split(' ').filter({
                    "ConsciousnessStream.useCallback[startDeepThink].words": (w)=>w.length > 6
                }["ConsciousnessStream.useCallback[startDeepThink].words"]).slice(0, 5);
                words.forEach({
                    "ConsciousnessStream.useCallback[startDeepThink]": (w)=>addNode(w, 'inference')
                }["ConsciousnessStream.useCallback[startDeepThink]"]);
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$genesis$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: loading ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$genesis$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: thought || /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$genesis$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$genesis$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$genesis$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$genesis$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(SynapticNetwork, {
                                    nodes: nodes,
                                    active: !loading
                                }, void 0, false, {
                                    fileName: "[project]/Desktop/genesis/components/ConsciousnessStream.tsx",
...
_s1(ConsciousnessStream, "3KxoKlXR3XlOir3Pqd9kHZS/0fA=");
_c1 = ConsciousnessStream;
const __TURBOPACK__default__export__ = ConsciousnessStream;
var _c, _c1;
__turbopack_context__.k.register(_c, "SynapticNetwork");
__turbopack_context__.k.register(_c1, "ConsciousnessStream");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=Desktop_genesis_12cd6f6f._.js.map