module.exports = [
"[project]/Desktop/genesis/components/AdminDashboard.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const AdminDashboard = ({ onClose })=>{
    const [config, setConfig] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$genesis$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(__TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$genesis$2f$services$2f$adminService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["adminService"].getConfig());
    const [unsaved, setUnsaved] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$genesis$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(false);
    const [appwriteStatus, setAppwriteStatus] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$genesis$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])('NON CONNECTÉ');
    ...
    const checkAppwriteConnection = async ()=>{
        ...
        try {
            ...
            const current = __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$genesis$2f$services$2f$adminService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["adminService"].getConfig().appwrite;
            if (current.isActive && current.projectId) {
                // On tente une connexion simple (ex: list documents ou verifyConnection)
                const { appwriteService } = await __turbopack_context__.A("[project]/Desktop/genesis/services/appwriteService.ts [app-ssr] (ecmascript, async loader)"); // Import dynamique pour éviter les cycles
    ...
    const handleSave = async ()=>{
        __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$genesis$2f$services$2f$adminService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["adminService"].saveConfig(config);
        setUnsaved(false);
        __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$genesis$2f$services$2f$sfx$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["sfx"].playConfirm();
...
//# sourceMappingURL=Desktop_genesis_components_AdminDashboard_tsx_1e3013df._.js.map