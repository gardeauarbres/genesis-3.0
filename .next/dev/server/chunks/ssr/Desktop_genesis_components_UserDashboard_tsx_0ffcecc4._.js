module.exports = [
"[project]/Desktop/genesis/components/UserDashboard.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const UserDashboard = ({ identity, onNavigate })=>{
    ...
    const [userId, setUserId] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$genesis$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(("TURBOPACK compile-time falsy", 0) ? "TURBOPACK unreachable" : null);
    ...
    const [decryptedName, setDecryptedName] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$genesis$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(identity);
    ...
    const saveNotes = async (val)=>{
        ...
        if (userId && syncStatus === 'CLOUD') {
            await __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$genesis$2f$services$2f$appwriteService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["appwriteService"].updateUserProfile(userId, {
                notes: val
            });
        }
    };
    ...
    const handleNav = (view)=>{
        __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$genesis$2f$services$2f$sfx$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["sfx"].playSelect();
        onNavigate(view);
    };
...
//# sourceMappingURL=Desktop_genesis_components_UserDashboard_tsx_0ffcecc4._.js.map